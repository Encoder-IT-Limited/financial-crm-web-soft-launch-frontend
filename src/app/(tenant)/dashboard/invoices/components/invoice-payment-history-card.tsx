...
/** The invoice detail page's "Payment history" card — extracted verbatim;
 * behavior unchanged. */
export function InvoicePaymentHistoryCard({ payments, currency }: { payments: Payment[]; currency: Currency }) {
  return (

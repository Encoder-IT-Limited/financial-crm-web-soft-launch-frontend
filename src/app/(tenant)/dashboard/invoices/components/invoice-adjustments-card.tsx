...
/** The invoice detail page's "Adjustments" card (linked credit/debit notes)
 * — extracted verbatim; behavior unchanged. Only rendered by the caller
 * when there's at least one linked adjustment. */
export function InvoiceAdjustmentsCard({ adjustments, currency }: { adjustments: Adjustment[]; currency: Currency }) {
  return (
